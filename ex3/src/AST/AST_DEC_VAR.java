...
public class AST_DEC_VAR extends AST_DEC
{
	...
	public TYPE SemantMe()
	{
		...
		/**************************************/
		SYMBOL_TABLE_ENTRY prev = SYMBOL_TABLE.getInstance().find(name);
		if (prev != null)
		{
			SYMBOL_TABLE_ENTRY scope = SYMBOL_TABLE.getInstance().getScope();
			if(scope.prevtop_index < prev.prevtop_index){
				/* if the name was already declared within the current scope*/
